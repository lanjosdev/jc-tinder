...
// Estilo:
import './modalphotoforms.css';


ModalPhotoForms.propTypes = {
...
export function ModalPhotoForms({ 
    close, 
    filesPhotos,
    setFilesPhotos,
    urlsPhotos,
